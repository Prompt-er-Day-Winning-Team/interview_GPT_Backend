...
class Interview(Base):
    ...
    goal: str = Column(Text(collation="utf8_unicode_ci"))
    target_user: str = Column(Text(collation="utf8_unicode_ci"))
    status: str = Column(String(10, collation="utf8_unicode_ci"), nullable=False)
    ...
    def __repr__(self):
        return f"Interview-{self.interview_id}-{self.product_name}-{self.goal}"
